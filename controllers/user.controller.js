...
// client passes images in binary form and then we convert it into image using 'multer'
// and then save in cloudinary.
export const registerUser = asyncHandler(async (req, res, next) => {// using form in thunder client.
  ...
  const user = await User.create({
    ...
    avatar: {
      ...
      secure_url:
        ...
        'https://res.cloudinary.com/dvv8llsng/image/upload/t_media_lib_thumb/cld-sample.jpg',
    },
  });
  ...
  if (req.file) { // dont know in server why image is not stored in cloudinary.
    try {
